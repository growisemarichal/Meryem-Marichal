...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ia(){return new _i({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Ra(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function La(){return new _i({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ra(),fragmentShader:`
	...
	`}var za=class extends Vt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new ni(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`;var Nc=Mc.querySelector(`.c3d-scene`),Pc=new Dn,Fc=new Hi(40,Nc.clientWidth/Nc.clientHeight,.1,100);Fc.position.set(0,0,9);var Ic=new wc({antialias:!0,alpha:!0});Ic.setSize(Nc.clientWidth,Nc.clientHeight),Ic.setPixelRatio(Math.min(window.devicePixelRatio,2)),Nc.appendChild(Ic.domElement);function Lc(){let e=new ci(Ec,Dc,48,1),t=e.attributes.position,n=Ec/2;for(let e=0;e<t.count;e++){let r=t.getX(e)/n,i=Oc*(1-r*r);t.setZ(e,i)}return e.computeVertexNormals(),e}var Rc=Lc(),zc=Vc(),Bc=new ci(Ec*1.7,Dc*1.9);function Vc(){let e=document.createElement(`canvas`);e.width=256,e.height=256;let t=e.getContext(`2d`),n=t.createRadialGradient(128,128,10,128,128,128);return n.addColorStop(0,`rgba(0,0,0,0.85)`),n.addColorStop(.5,`rgba(0,0,0,0.4)`),n.addColorStop(1,`rgba(0,0,0,0)`),t.fillStyle=n,t.fillRect(0,0,e.width,e.height),new ri(e)}var Hc=new Map;function Uc(e){return Hc.has(e)||Hc.set(e,new Promise((t,n)=>{let r=new Image;r.onload=()=>t(r),r.onerror=n,r.src=e})),Hc.get(e)}async function Wc(e){let t=await Uc(e),n=t.naturalWidth,r=t.naturalHeight,i=n*.0875,a=document.createElement(`canvas`);a.width=n,a.height=r;let o=a.getContext(`2d`);o.save(),o.beginPath(),o.roundRect(0,0,n,r,i),o.clip(),o.drawImage(t,0,0,n,r),o.restore();let s=new ri(a);return s.colorSpace=Pe,s.anisotropy=Ic.capabilities.getMaxAnisotropy(),s}var Gc=new yn;Pc.add(Gc);var Kc=Tc.map(e=>{let t=new yn,n=new Wr(Bc,new Mr({map:zc,transparent:!0,depthWrite:!1}));n.position.set(0,-.35,-.6),t.add(n);let r=new Mr({color:789516,side:2,transparent:!0}),i=new Wr(Rc,r);return t.add(i),Wc(e.image).then(e=>{r.map=e,r.color.set(16777215),r.needsUpdate=!0}),Gc.add(t),{cardGroup:t,card:i,shadow:n}}),qc=Math.floor((Tc.length-1)/2),Jc=qc,Yc=qc;function Xc(e){Kc.forEach(({cardGroup:e,card:t,shadow:n},r)=>{let i=(r-Yc)*Ac;e.position.x=Math.sin(i)*kc,e.position.y=jc*(Math.cos(i)-1),e.rotation.y=i;let a=Math.cos(i),o=a<.05;t.material.opacity=o?0:xt.clamp(.3+a*.8,.25,1),n.material.opacity=o?0:xt.clamp(.25+a*.55,.1,.8);let s=xt.clamp(.75+a*.3,.72,1.05);e.scale.setScalar(s)})}function Zc(){let e=Tc.length>1?qc/(Tc.length-1)*100:0;Mc.querySelector(`.c3d-progress-fill`).style.width=`${e}%`}function Qc(e){qc=xt.clamp(e,0,Tc.length-1),Jc=qc,Zc()}Mc.querySelector(`.c3d-arrow-left`).addEventListener(`click`,()=>Qc(qc-1)),Mc.querySelector(`.c3d-arrow-right`).addEventListener(`click`,()=>Qc(qc+1));var $c=!1;Nc.addEventListener(`wheel`,e=>{e.preventDefault();let t=Math.abs(e.deltaX)>Math.abs(e.deltaY)?e.deltaX:e.deltaY;$c||Math.abs(t)<4||($c=!0,setTimeout(()=>$c=!1,220),Qc(t>0?qc+1:qc-1))},{passive:!1});var el=180,tl=!1,nl=0,rl=0,il=0,al=0,ol=0;function sl(e){tl=!0,Nc.classList.add(`is-dragging`),nl=e.clientX,rl=Yc,il=e.clientX,al=performance.now(),ol=0,Nc.setPointerCapture(e.pointerId)}function cl(e){if(!tl)return;let t=performance.now(),n=Math.max(t-al,1),r=e.clientX-nl;Yc=rl-r/el,Jc=Yc,ol=-((e.clientX-il)/el)/(n/1e3),il=e.clientX,al=t}function ll(e){tl&&(tl=!1,Nc.classList.remove(`is-dragging`),Nc.releasePointerCapture(e.pointerId),Qc(Math.round(Yc)+(Math.abs(ol)>1.2?Math.sign(ol):0)))}Nc.addEventListener(`pointerdown`,sl),Nc.addEventListener(`pointermove`,cl),Nc.addEventListener(`pointerup`,ll),Nc.addEventListener(`pointercancel`,ll),Zc();function ul(e){requestAnimationFrame(ul),tl||(Yc+=(Jc-Yc)*.08),Xc(e),Ic.render(Pc,Fc)}ul(0),window.addEventListener(`resize`,()=>{Fc.aspect=Nc.clientWidth/Nc.clientHeight,Fc.updateProjectionMatrix(),Ic.setSize(Nc.clientWidth,Nc.clientHeight)});